...
export const messages = {
  zh: {
    ...
    statusParsed: "待标注", statusQueued: "排队中", statusExtracting: "处理中", statusReviewable: "待标注", statusCompleted: "首轮已完成", statusApproved: "已采用", statusSkipped: "已 Pass", statusUncertain: "不确定", statusPredicted: "待审核", statusPending: "未处理",
    ...
    page: "第 {number} 页", formula: "独立公式", sentenceNumber: "句子 {number}", revisionCount: "已保存 {count} 次", ontology: "本体", manualAnnotation: "人工实体标注", manualHint: "请在当前句子或公式中拖动选择文本，再选择实体类型并添加。每次保存都会形成新版本，KG 使用最新版本，保存次数不限。",
  ...
  en: {
    ...
    statusParsed: "Ready to annotate", statusQueued: "Queued", statusExtracting: "Processing", statusReviewable: "Ready to annotate", statusCompleted: "First pass complete", statusApproved: "Accepted", statusSkipped: "Passed", statusUncertain: "Uncertain", statusPredicted: "Pending review", statusPending: "Pending",
    ...
    page: "Page {number}", formula: "Display formula", sentenceNumber: "Sentence {number}", revisionCount: "{count} saved versions", ontology: "Ontology", manualAnnotation: "Manual entity annotation", manualHint: "Select text in the current sentence or formula, choose an entity type, and add it. Every save creates a new version; the KG uses the latest version, with no revision limit.",

...
export const messages = {
  zh: {
    ...
    emptyDocuments: "上传一篇文本型 PDF 开始标注", runExtraction: "执行抽取", startAnnotation: "开始标注", viewAnnotation: "查看标注", continueAnnotation: "继续标注", downloadMarkdown: "下载干净 MD", delete: "删除",
    parsingPdf: "正在上传 PDF…", parsedPdf: "PDF 解析与分句完成", parseQueued: "PDF 已加入后台解析；你可以继续标注其他文档", extractionProgress: "正在处理 {percent}%", deleting: "正在删除 {name}…", deleted: "已删除 {name}",
    deleteConfirm: "确定删除“{name}”吗？\n\n对应的句子、人工标注版本和图谱记录也会删除，此操作无法撤销。",
    statusParsed: "待标注", statusParsing: "后台解析中", statusParseFailed: "解析失败", statusQueued: "排队中", statusExtracting: "处理中", statusReviewable: "待标注", statusAnnotating: "标注中", statusCompleted: "首轮已完成", statusApproved: "已采用", statusSkipped: "已 Pass", statusUncertain: "不确定", statusPredicted: "待审核", statusPending: "未处理", documentProgress: "已处理 {reviewed}/{total}", highestVersion: "最高版本 {count}",
    ...
    llmAssist: "LLM 辅助推荐", llmAssistHint: "仅在点击后分析本句；推荐不会自动写入标注。", generateSuggestions: "生成推荐", generatingSuggestions: "生成中…", suggestionFailed: "推荐生成失败", suggestedEntities: "推荐实体", suggestedRelations: "推荐关系", noSuggestions: "本句未发现可推荐的实体或关系", applySuggestions: "应用到当前标注", dismissSuggestions: "忽略", suggestionsApplied: "已应用 LLM 推荐，请检查后再保存", modelLabel: "模型",
    ...
    pass: "Pass · 无需标注", passTitle: "确认本句不需要进入知识图谱", markUncertain: "标记不确定", saveNext: "保存并进入下一句", entities: "实体", relations: "关系", deleteEntity: "删除实体", deleteRelation: "删除关系", manual: "人工",
  ...
  en: {
    ...
    emptyDocuments: "Upload a text-based PDF to begin", runExtraction: "Run extraction", startAnnotation: "Start annotation", viewAnnotation: "View annotation", continueAnnotation: "Continue annotation", downloadMarkdown: "Download clean MD", delete: "Delete",
    parsingPdf: "Uploading PDF…", parsedPdf: "PDF parsed and segmented", parseQueued: "PDF queued for background parsing; you can continue annotating other documents", extractionProgress: "Processing {percent}%", deleting: "Deleting {name}…", deleted: "Deleted {name}",
    deleteConfirm: "Delete “{name}”?\n\nIts sentences, manual annotation versions, and graph records will also be deleted. This cannot be undone.",
    statusParsed: "Ready to annotate", statusParsing: "Parsing in background", statusParseFailed: "Parse failed", statusQueued: "Queued", statusExtracting: "Processing", statusReviewable: "Ready to annotate", statusAnnotating: "In progress", statusCompleted: "First pass complete", statusApproved: "Accepted", statusSkipped: "Passed", statusUncertain: "Uncertain", statusPredicted: "Pending review", statusPending: "Pending", documentProgress: "Reviewed {reviewed}/{total}", highestVersion: "Highest version {count}",
    ...
    llmAssist: "LLM suggestions", llmAssistHint: "Analyzes this sentence only when requested; suggestions are never saved automatically.", generateSuggestions: "Generate suggestions", generatingSuggestions: "Generating…", suggestionFailed: "Suggestion failed", suggestedEntities: "Suggested entities", suggestedRelations: "Suggested relations", noSuggestions: "No entity or relation suggestions for this sentence", applySuggestions: "Apply to annotation", dismissSuggestions: "Dismiss", suggestionsApplied: "LLM suggestions applied. Review them before saving.", modelLabel: "Model",
    ...
    pass: "Pass · No annotation", passTitle: "Confirm that this sentence should not enter the knowledge graph", markUncertain: "Mark uncertain", saveNext: "Save and continue", entities: "Entities", relations: "Relations", deleteEntity: "Delete entity", deleteRelation: "Delete relation", manual: "Manual",
